...
## What's Changed
* fix(ci): stop publishing the project icon to 'dist' by @coffeebeats in https://github.com/coffeebeats/godot-plugin-template/pull/133


**Full Changelog**: https://github.com/coffeebeats/godot-plugin-template/compare/v6.0.1...v6.0.2

## 6.0.1 (2026-09-15)

## What's Changed
* chore(claude): enable godot-infra's 'godot' agent plugin by @coffeebeats in https://github.com/coffeebeats/godot-plugin-template/pull/131


**Full Changelog**: https://github.com/coffeebeats/godot-plugin-template/compare/v6.0.0...v6.0.1
...
* chore(deps): bump googleapis/release-please-action from 4.3.0 to 4.4.0 by @dependabot[bot] in https://github.com/coffeebeats/godot-plugin-template/pull/92
* chore!: update to Godot `v4.5` by @coffeebeats in https://github.com/coffeebeats/godot-plugin-template/pull/93


**Full Changelog**: https://github.com/coffeebeats/godot-plugin-template/compare/v2.0.2...v3.0.0
